...
class Table(QThread):
    ...
    def run(self):
        ...
        while winner == 0:
            ...
            ai_action = self.choice(ai1_state, dict, ai1_hands, ai1_board, ai2_board, 0, eval, 1)

            temp1 = ai1_hands.pop(ai_action)
            temp2 = ai2_hands.pop(player_action)
            ...
            if (check_turn(ai1_board, ai2_board) == 1):
                ...
                if (ai_action == 2):
                    winner = 2
                    break
                stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet1(ai_action, stake,
                                                                                            table_stake, 1, ai1_state,
                                                                                            ai2_state, best_fund,
                                                                                            challenger_fund)
                ...
                if (player_action == 2):
                    winner = 1
                    break
                stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet1(player_action, stake,
                                                                                            table_stake, 2, ai1_state,
                                                                                            ai2_state, best_fund,
                                                                                            challenger_fund)
            ...
            if (check_turn(ai1_board, ai2_board) == 1):
                ...
                if (ai_action == 2):
                    winner = 2
                    break
                stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet2(ai_action, stake,
                                                                                            table_stake, 1, ai1_state,
                                                                                            ai2_state, best_fund,
                                                                                            challenger_fund)
                ...
                if (player_action == 2):
                    winner = 1
                    break
                stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet2(player_action, stake,
                                                                                            table_stake, 2, ai1_state,
                                                                                            ai2_state, best_fund,
                                                                                            challenger_fund)
                ...
                if (player_action == 1):
                    while (True):
                        ...
                        if (player_action == 2):
                            winner = 1
                            break
                        stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet2(player_action,
                                                                                                    stake, table_stake,
                                                                                                    2, ai1_state,
                                                                                                    ai2_state,
                                                                                                    best_fund,
            ...
            if (table_stake < 1500000):
                if (check_turn(ai1_board, ai2_board) == 1):
                    ai_action = self.choice(ai1_state, dict, ai1_hands, ai1_board, ai2_board, 1, eval, 1)

                    if (ai_action == 2):
                        winner = 2
                        break
                    stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet3(ai_action, stake,
                                                                                                table_stake, 1,
                                                                                                ai1_state, ai2_state,
                                                                                                best_fund,
                                                                                                challenger_fund)
                    ...
                    if (player_action == 2):
                        winner = 1
                        break
                    stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet3(player_action, stake,
                                                                                                table_stake, 2,
                                                                                                ai1_state, ai2_state,
                                                                                                best_fund,
                                                                                                challenger_fund)
                    ...
                    if (player_action == 1):
                        while (True):
                            ...
                            if (ai_action == 2):
                                winner = 2
                                break
                            stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet2(ai_action,
                                                                                                        stake,
                                                                                                        table_stake, 1,
                                                                                                        ai1_state,
                                                                                                        ai2_state,
                    ...
                    if (ai_action == 1):
                        while (True):
                            ...
                            if (player_action == 2):
                                winner = 1
                                break
                            stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet3(player_action,
                                                                                                        stake,
                                                                                                        table_stake, 2,
                                                                                                        ai1_state,
                                                                                                        ai2_state,
                            ...
                            if (ai_action == 2):
                                winner = 2
                                break
                            stake, table_stake, ai1_state, ai2_state, best_fund, challenger_fund = bet3(ai_action,
                                                                                                        stake,
                                                                                                        table_stake, 1,
                                                                                                        ai1_state,
                                                                                                        ai2_state,
